...
class boostools_Public {
	...
	public function enqueue_styles() {
		...
		//wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/boostools-public.css', array(), $this->version, 'all' );
	...
	public function embed_code() {
		$script = get_option( 'boostools_script' );
		if(strlen( $script )>8){
			echo $script;
		}
	}
